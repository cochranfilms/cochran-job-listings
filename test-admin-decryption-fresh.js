/**
 * Admin Decryption Fresh Test
 * Tests admin decryption with the fresh bank data
 */

const puppeteer = require('puppeteer');

async function testAdminDecryptionFresh() {
    console.log('🔍 Admin Decryption Fresh Test...\n');
...
// Run the test
testAdminDecryptionFresh().catch(console.error); 