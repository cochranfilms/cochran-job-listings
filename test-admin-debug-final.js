/**
 * Admin Debug Final Test
 * Tests with new debugging to see detailed error messages
 */

const puppeteer = require('puppeteer');

async function testAdminDebugFinal() {
    console.log('🔍 Admin Debug Final Test...\n');
...
// Run the test
testAdminDebugFinal().catch(console.error); 